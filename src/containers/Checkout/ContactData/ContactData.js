...
class ContactData extends Component {
  ...
  orderHandler = (event) => {
    ...
    /**
     * Abis order harus redirect ke home (jika berhasil di post),
     * caranya banyak, bisa kita passing props router lalu redirect
     * tetapi ada approach lain menggunakan logika Redux
     * Lihat di Checkout.js
     */
  };
...
const mapDispatchToProps = (dispatch) => {
  return {
    onOrderBuger: (order) => dispatch(purchaseBurger(order))
  };
};
...
export default connect(
  mapStateToProps,
  mapDispatchToProps
)(withErrorHandling(ContactData, axiosOrder));
